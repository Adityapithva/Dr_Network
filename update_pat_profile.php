...
if(isset($_POST['update_pat_profile'])){
    $update_name = mysqli_real_escape_string($conn,$_POST['update_name']);
    $update_ph_no =  mysqli_real_escape_string($conn,$_POST['update_ph_no']);
    $update_email =  mysqli_real_escape_string($conn,$_POST['update_email']);
    $update_pass =  mysqli_real_escape_string($conn,$_POST['update_pass']);
    $sql3 = "update patients set name='$update_name',contact_details = '$update_ph_no',email='$update_email' where user_id = '$u_id'";
        ...
        <form action="" method="post">
            ...
            <div class="flex">
                <div class="inputBox">
                    ...
                    <input type="text" name="update_id" value="<?php echo $row['patient_id']?>" class="box">
                </div>
                <div class="inputBox">
                    <span>User Id:</span>
                    <input type="text" name="update_id" value="<?php echo $row['user_id']?>" class="box">
                </div>
                <div class="inputBox">
                    <span>User Name:</span>
                ...
                <div class="inputBox">
                    ...
                    <input type="text" name="update_ph_no" value="<?php echo $row['contact_details']?>" class="box">
                </div>
                <div class="inputBox">
                    <span>Email:</span>
                ...
                <div class="inputBox">
                    <span>Password:</span>
                    <input type="password" name="update_pass" value="<?php echo $row2['password']?>" class="box">
                </div>
            </div>
            <input type="submit" value="Update Profile" name="update_pat_profile" class="btn">
            <a href="patprofile.php" class="delete-btn">Go Back</a>
        </form>
    </div>
</body>
</html>